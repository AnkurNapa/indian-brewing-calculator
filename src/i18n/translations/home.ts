...
export const homeTranslations = {
  ...
  'home.vitals.title': { en: 'Brew Vitals', de: 'Kennzahlen', hi: 'ब्रू विटल्स', mr: 'ब्रू विटल्स' },
  'home.vitals.og': { en: 'Est. OG', de: 'Erw. SG', hi: 'अनुमानित OG', mr: 'अंदाजित OG' },
  'home.vitals.abv': { en: 'ABV', de: 'Alk.', hi: 'ABV', mr: 'ABV' },
  'home.vitals.ibu': { en: 'IBU', de: 'IBU', hi: 'IBU', mr: 'IBU' },
  'home.vitals.color': { en: 'Color', de: 'Farbe', hi: 'रंग', mr: 'रंग' },
  'home.vitals.styleMatch': { en: 'Style match', de: 'Stiltreffer', hi: 'शैली मिलान', mr: 'शैली जुळणी' },
  'home.vitals.styleMatchValue': { en: '{count}/5', de: '{count}/5', hi: '{count}/5', mr: '{count}/5' },
  'home.vitals.emptyHint': {
    en: 'Add grain, hops, and gravity to see your recipe come to life.',
    de: 'Fügen Sie Malz, Hopfen und Stammwürze hinzu, um Ihr Rezept zum Leben zu erwecken.',
    hi: 'अपनी रेसिपी को जीवंत देखने के लिए ग्रेन, हॉप्स और गुरुत्व जोड़ें।',
    mr: 'तुमची पाककृती जिवंत पाहण्यासाठी ग्रेन, हॉप्स आणि गुरुत्व जोडा.',
  },
